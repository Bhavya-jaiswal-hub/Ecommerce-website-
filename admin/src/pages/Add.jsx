 ...
 const [sizes,setSizes]  = useState([]);
  ...
  <input onChange={(e) => setImage4(e.target.files[0])} type="file" id="image4" hidden />
     ...
     <div className='w-full'>
        ...
        <textarea  onChange = {(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='write Contect here' required/>
     </div>  

     <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
            <p className='mb-2'>Product 
                Category
            </p>
     ...
     <button type='submnit' className='w-28 py-3 mt-4 bg-black text-white'>
               ADD
     </button>
    </form>
  )
